...
////DRAW THE PICTURE
int times = 0;
int DRAW_POINT[DRAWLENGTH] = {63,63,63,63,63,63,63,63,63,63,63,63}; //127 * 63
int DRAW = -1;
int L_DRAW = -1;
////
///////AI PART
...
char* OUT[AI_NETWORK_OUT_1_SIZE ] = {
  "AM","C","DM","EM","F","G","..."
};
int count[AI_NETWORK_OUT_1_SIZE ] ={0};
uint32_t cls;
